...
test('input: an idle read is two zero sticks, and feeds the HUD knobs', () => {
  ...
  assert.deepEqual(input.read(), { L: { x: 0, y: 0, active: false }, R: { x: 0, y: 0, active: false }, look: { x: 0, y: 0, active: false, homing: false, down: 85 }, holdR: false });
...
test('input: keyboard can be disabled, hud can be missing, dispose removes every listener', () => {
  ...
  assert.deepEqual(bare.read(), { L: { x: 0, y: 0, active: false }, R: { x: 0, y: 0, active: false }, look: { x: 0, y: 0, active: false, homing: false, down: 85 }, holdR: false });
  bare.dispose();
});
